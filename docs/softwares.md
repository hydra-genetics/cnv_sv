...
## [melt_concat](https://github.com/samtools/bcftools)
Concatenates the VCF files generated by MELT for each mobile element type using bcftools.

### :snake: Rule

#SNAKEMAKE_RULE_SOURCE__melt__melt_concat#

#### :left_right_arrow: input / output files

#SNAKEMAKE_RULE_TABLE__melt__melt_concat#

### :wrench: Configuration

#### Software settings (`config.yaml`)

#CONFIGSCHEMA__melt_concat#

#### Resources settings (`resources.yaml`)

#RESOURCESSCHEMA__melt_concat#

---

## [melt_vcf](https://github.com/hydra-genetics/cnv_sv/blob/develop/workflow/scripts/melt_vcf.py)
A custom script that converts MELT VCF files into a format compatible with downstream `vcf` workflows.
### :snake: Rule

#SNAKEMAKE_RULE_SOURCE__melt__melt_vcf#

#### :left_right_arrow: input / output files

#SNAKEMAKE_RULE_TABLE__melt__melt_vcf#

### :wrench: Configuration

#### Software settings (`config.yaml`)

#CONFIGSCHEMA__melt_vcf#

#### Resources settings (`resources.yaml`)

#RESOURCESSCHEMA__melt_vcf#
...
### [reviewer_bam_sort](https://github.com/Illumina/REViewer)
Sort and index the realigned BAM file from ExpansionHunter using samtools.

#### :snake: Rule

#SNAKEMAKE_RULE_SOURCE__reviewer__reviewer_bam_sort#

##### :left_right_arrow: input / output files

#SNAKEMAKE_RULE_TABLE__reviewer__reviewer_bam_sort#

#### :wrench: Configuration

##### Software settings (`config.yaml`)

#CONFIGSCHEMA__reviewer_bam_sort#

##### Resources settings (`resources.yaml`)

#RESOURCESSCHEMA__reviewer_bam_sort#
...
## [scramble_vcf](https://github.com/hydra-genetics/cnv_sv/blob/scramble_mobile_elements/workflow/scripts/scramble_vcf.py)
An in-house script that converts the SCRAMble read cluster analysis output into a file compatible with the `vcf` file format used for downstream analysis.

### :snake: Rule

#SNAKEMAKE_RULE_SOURCE__scramble__scramble_vcf#

#### :left_right_arrow: input / output files

#SNAKEMAKE_RULE_TABLE__scramble__scramble_vcf#

### :wrench: Configuration

#### Software settings (`config.yaml`)

#CONFIGSCHEMA__scramble_vcf#

#### Resources settings (`resources.yaml`)

#RESOURCESSCHEMA__scramble_vcf#

---

## [scramble_sort](http://samtools.github.io/bcftools/bcftools.html)
Reheaders and sorts the VCF file generated by scramble_vcf using bcftools reheader and bcftools sort.

### :snake: Rule

#SNAKEMAKE_RULE_SOURCE__scramble__scramble_sort#

#### :left_right_arrow: input / output files

#SNAKEMAKE_RULE_TABLE__scramble__scramble_sort#

### :wrench: Configuration

#### Software settings (`config.yaml`)

#CONFIGSCHEMA__scramble_sort#

#### Resources settings (`resources.yaml`)

#RESOURCESSCHEMA__scramble_sort#
