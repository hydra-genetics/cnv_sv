...
## [melt_vcf](https://github.com/hydra-genetics/cnv_sv/blob/scramble_mobile_elements/workflow/scripts/melt_vcf.py)
An custom script that converts the MELT VCF files into a format compatible with the `vcf` file format used for downstream analysis.
