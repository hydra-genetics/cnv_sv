...
rule manta_run_workflow_tn:
    ...
    output:
        cand_si_vcf="cnv_sv/manta/{sample}/results/variants/candidateSmallIndels.vcf.gz",
        cand_si_tbi="cnv_sv/manta/{sample}/results/variants/candidateSmallIndels.vcf.gz.tbi",
        cand_sv_vcf="cnv_sv/manta/{sample}/results/variants/candidateSV.vcf.gz",
        cand_sv_tbi="cnv_sv/manta/{sample}/results/variants/candidateSV.vcf.gz.tbi",
        dipl_sv_vcf="cnv_sv/manta/{sample}/results/variants/diploidSV.vcf.gz",
        dipl_sv_tbi="cnv_sv/manta/{sample}/results/variants/diploidSV.vcf.gz.tbi",
