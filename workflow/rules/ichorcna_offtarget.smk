...
rule ichorcna_offtarget_read_counter:
    ...
    params:
        ...
        # get configured for ichorcna_offtarget_run below, or loadReadCountsFromWig()
        # hits a length mismatch assigning gc/map values onto this rule's read counts.
        # ichorCNA's own bundled wigs only ship at 10/50/500/1000kb - this 100kb
        # default has no matching bundled file and requires a custom-generated
        # gc_wig/map_wig at the same 100kb bin size (see docs).
